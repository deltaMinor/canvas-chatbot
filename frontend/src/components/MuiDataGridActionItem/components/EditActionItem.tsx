...
const EditActionItemComponent = ({
    disabled, //
    hideIfDisabled,
    tooltipTitle = DefaultActionTooltipTitle.edit,
    // tooltipTitleAlt = DefaultActionTooltipTitle.editAlt,
    // variant = "",
    getUrl = () => undefined,
    handleClick = async () => {},
    shouldDisable = () => false,
...
export default React.memo(EditActionItemComponent);
