...
const AcceptActionItemComponent = ({
    disabled, //
    hideIfDisabled,
    tooltipTitle = DefaultActionTooltipTitle.accept,
    // tooltipTitleAlt = DefaultActionTooltipTitle.acceptAlt,
    // variant = "",
    getUrl = () => undefined,
    handleClick = async () => {},
    shouldDisable = () => false,
...
export default React.memo(AcceptActionItemComponent);
