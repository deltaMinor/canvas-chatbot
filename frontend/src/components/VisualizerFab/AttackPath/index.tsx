...
interface ViewAttackPathFabProps {
    isOpen: boolean;
    isPending?: boolean;
...
const ViewAttackPathFabComponent = ({
    isOpen,
    isPending = false,
    onPendingEntered,
    handleClick,
}: ViewAttackPathFabProps) => {
    ...
    return (
        ...
        >
            ...
            <ButtonBase
                id="ViewAttackPathFabComponent__button"
                disabled={isPending}
                onClick={handleClick}
                sx={(theme) => ({
                    position: "relative",
                    ...
                    "&:hover .view-attack-path-label": {
                        opacity: 1,
                        maxWidth: 92,
                    },
                    "&:hover .view-attack-path-icon-slot": {
                        left: "auto",
                        top: "50%",
                        right: 0,
                    ...
                    ...(isPending && {
                        "& .view-attack-path-label": {
                            opacity: 1,
                            maxWidth: 92,
                        },
                        "& .view-attack-path-icon-slot": {
                            left: "auto",
                            top: "50%",
                            right: 0,
                            transform: "translateY(-50%)",
            ...
            >
                <Typography
                    variant="caption"
                    className="view-attack-path-label"
                    sx={{
                        position: "absolute",
                        left: 14,
                        right: 36,
                ...
                <Box
                    className="view-attack-path-icon-slot"
                    sx={{
                        position: "absolute",
                        top: "50%",
                        left: "50%",
                ...
                >
                    {isPending ? (
                        ...
                        <AltRouteRounded sx={{ fontSize: 20, width: 20, height: 20 }} />
                    )}
                </Box>
            </ButtonBase>
        </Box>
...
export default React.memo(ViewAttackPathFabComponent);
