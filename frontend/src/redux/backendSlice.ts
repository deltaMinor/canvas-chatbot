...
const legacyInitialState: LegacyBackendState = {
    ...
    attackFlowsGroupingsLoaded: false,
    attackFlowsGroupingsLoadError: false,
    ...
    kbCsaCCoP: null,
    kbCsaCCoPLoaded: false,
    kbCsaCCoPLoadError: false,
    kbIM8: null,
    kbIM8Loaded: false,
    kbIM8LoadError: false,
    kbISOIEC27001: null,
    kbISOIEC27001Loaded: false,
    kbISOIEC27001LoadError: false,
    kbMitre: null,
    kbMitreLoaded: false,
    kbMitreLoadError: false,
    kbNistCSF: null,
    kbNistCSFLoaded: false,
    kbNistCSFLoadError: false,
    ...
    projectAssessmentConfig: null,
    projectAssessmentConfigLoaded: false,
    projectAssessmentConfigLoadError: false,
    masterCQ: null,
    masterCQLoaded: false,
    masterCQLoadError: false,
    masterCQTemplate: null,
    masterCQTemplateLoaded: false,
    masterCQTemplateLoadError: false,
    ...
    projectCQ: null,
    projectCQLoaded: false,
    projectCQLoadError: false,
    projectCQLogs: [],
    projectCQLogsLoaded: false,
    projectCQLogsLoadError: false,
    projectCQTemplate: null,
    projectCQTemplateLoaded: false,
    projectCQTemplateLoadError: false,
    projectDiagram: null,
