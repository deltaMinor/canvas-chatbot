...
export interface NodeDrawerTabContentProps {
...
const NodeDrawerTabContentComponent = ({
    groups,
    editable,
    handleAddAttribute,
    handleRemoveLocal,
    handleRenewAttribute,
}: NodeDrawerTabContentProps) => {
...
export default React.memo(NodeDrawerTabContentComponent);
