...
export enum DialogStateEnum {
    ...
    kbCsaCCoPDatabase = "kbCsaCCoPDatabase",
    kbIM8Database = "kbIM8Database",
    kbNistCSFDatabase = "kbNistCSFDatabase",
    kbISOIEC27001Database = "kbISOIEC27001Database",
    // Policy -> associated mitigation measures dialogs
    kbCsaCCoPMitigations = "kbCsaCCoPMitigations",
    kbIM8Mitigations = "kbIM8Mitigations",
    kbNistCSFMitigations = "kbNistCSFMitigations",
    kbISOIEC27001Mitigations = "kbISOIEC27001Mitigations",
