...
default_code_message_mapping = {
    404: "Project CQ template not found.",
    409: "Project CQ template conflict.",
}

logger = logging.getLogger(__name__)


class ProjectCQTemplateService(
    DomainRepositoryService,
    DomainRequestDataPrefilterService,
    DomainAuditLogService,
    DomainProjectAuthorizationService,
):
    """Service for managing project CQ template entities.

    This service provides methods to interact with project CQ template entities,
    ...
    def __init__(
        ...
        """Initializes the ProjectCQTemplateService.
