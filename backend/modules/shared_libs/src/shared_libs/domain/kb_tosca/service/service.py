...
default_code_message_mapping = {
    404: "KB Tosca not found.",
    409: "KB Tosca conflict.",
}

logger = logging.getLogger(__name__)


class KbToscaService(
    DomainRepositoryService,
    DomainRequestDataPrefilterService,
    DomainAuditLogService,
    DomainAuthorizationService,
):
    """Service for managing KB Tosca entities.

    This service provides methods to interact with KB Tosca entities,
    ...
    Attributes:
        SCHEMA (dict): The schema definition for KB Tosca entities.
        repository (Repository | RemoteRepository): The repository instance for data access.
        data_store (GenericDataStore, optional): An optional data store for KB Tosca retrieval.
    """

    SCHEMA = schema_dict["kb_tosca"]
    ...
    def __init__(
        ...
        """Initializes the KbToscaService.
