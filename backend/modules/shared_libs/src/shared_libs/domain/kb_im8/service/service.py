...
class KbIM8Service(
    ...
    """Service for managing KB IM8 entities.

    This service provides methods to interact with KB IM8 entities,
    ...
    Attributes:
        SCHEMA (dict): The schema definition for KB IM8 entities.
        repository (Repository | RemoteRepository): The repository instance for data access.
        data_store (GenericDataStore, optional): An optional data store for KB IM8 retrieval.
    """

    SCHEMA = schema_dict["kb_im8"]
