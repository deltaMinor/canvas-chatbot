...
default_code_message_mapping = {
    404: "KB priority rules not found.",
    409: "KB priority rules conflict.",
}

logger = logging.getLogger(__name__)


class KbPriorityRulesService(
    DomainRepositoryService,
    DomainRequestDataPrefilterService,
    DomainAuditLogService,
    DomainAuthorizationService,
):
    """Service for managing KB Priority Rules entities.

    This service provides methods to interact with KB Priority Rules entities,
    ...
    Attributes:
        SCHEMA (dict): The schema definition for KB Priority Rules entities.
        repository (Repository | RemoteRepository): The repository instance for data access.
        data_store (GenericDataStore, optional): An optional data store for KB Priority Rules retrieval.
    """

    SCHEMA = schema_dict["kb_priority_rules"]
    ...
    def __init__(
        ...
        """Initializes the KbPriorityRulesService.
