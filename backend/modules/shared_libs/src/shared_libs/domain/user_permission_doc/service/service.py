...
default_code_message_mapping = {
    404: "User permission document not found.",
    409: "User permission document conflict.",
}

logger = logging.getLogger(__name__)


class UserPermissionDocService(
    DomainRepositoryService,
    DomainRequestDataPrefilterService,
    DomainAuditLogService,
    DomainAuthorizationService,
):
    """Service for managing user permission documents.

    This service provides methods to interact with user permission documents,
    ...
    Attributes:
        ...
        data_store (GenericDataStore, optional): An optional data store for document retrieval.
    """
    ...
    def __init__(
        ...
        """Initializes the UserPermissionDocService.
