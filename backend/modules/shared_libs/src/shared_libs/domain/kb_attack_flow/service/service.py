...
default_code_message_mapping = {
    404: "KB attack flow not found.",
    409: "KB attack flow conflict.",
}

logger = logging.getLogger(__name__)


class KbAttackFlowService(
    DomainRepositoryService,
    DomainRequestDataPrefilterService,
    DomainAuditLogService,
    DomainAuthorizationService,
):
    """Service for managing KB Attack Flow entities.

    This service provides methods to interact with KB Attack Flow entities,
    ...
    Attributes:
        SCHEMA (dict): The schema definition for KB Attack Flow entities.
        repository (Repository | RemoteRepository): The repository instance for data access.
        data_store (GenericDataStore, optional): An optional data store for KB Attack Flow retrieval.
    """

    SCHEMA = schema_dict["kb_attack_flow"]
    ...
    def __init__(
        ...
        """Initializes the KbAttackFlowService.
