...
default_code_message_mapping = {
    404: "Project register history not found.",
    409: "Project register history conflict.",
}

logger = logging.getLogger(__name__)


class ProjectRegisterHistoryService(
    DomainRepositoryService,
    DomainRequestDataPrefilterService,
    DomainAuditLogService,
    DomainProjectAuthorizationService,
):
    """Service for managing project register history entities.

    This service provides methods to interact with project register history entities,
    ...
    def __init__(
        ...
        """Initializes the ProjectRegisterHistoryService.
