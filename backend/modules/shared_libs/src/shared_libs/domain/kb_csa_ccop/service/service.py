...
default_code_message_mapping = {
    404: "KB CSA Codes Of Practice not found.",
    409: "KB CSA Codes Of Practice conflict.",
}

logger = logging.getLogger(AppLoggerName.domain_kb_csa_ccop.value)


class KbCsaCCoPService(
    DomainRepositoryService,
    DomainRequestDataPrefilterService,
    DomainAuditLogService,
    DomainAuthorizationService,
):
    """Service for managing KB CSA Codes Of Practice entities.

    This service provides methods to interact with KB CSA Codes Of Practice entities,
    ...
    Attributes:
        SCHEMA (dict): The schema definition for KB CSA Codes Of Practice entities.
        repository (Repository | RemoteRepository): The repository instance for data access.
        data_store (GenericDataStore, optional): An optional data store for KB CSA Codes Of Practice retrieval.
    """

    SCHEMA = schema_dict["kb_csa_ccop"]
    ...
    def __init__(
        ...
        """Initializes the KbCsaCCoPService.
