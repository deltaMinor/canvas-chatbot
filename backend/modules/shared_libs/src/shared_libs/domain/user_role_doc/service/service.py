...
default_code_message_mapping = {
    404: "User role document not found.",
    409: "User role document conflict.",
}

logger = logging.getLogger(__name__)


class UserRoleDocService(
    DomainRepositoryService,
    DomainRequestDataPrefilterService,
    DomainAuditLogService,
    DomainAuthorizationService,
):
    """Service for managing user role documents.

    This service provides methods to interact with user role documents,
    ...
    def __init__(
        ...
        """Initializes the UserRoleDocService.
