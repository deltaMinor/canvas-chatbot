...
default_code_message_mapping = {
    404: "KB LLM Prompt not found.",
    409: "KB LLM Prompt conflict.",
}

logger = logging.getLogger(__name__)


class KbLLMPromptService(
    DomainRepositoryService,
    DomainRequestDataPrefilterService,
    DomainAuditLogService,
    DomainAuthorizationService,
    ...
    """Service for managing KB LLM Prompt entities.

    This service provides methods to interact with KB LLM Prompt entities,
    ...
    Attributes:
        SCHEMA (dict): The schema definition for KB LLM Prompt entities.
        repository (Repository | RemoteRepository): The repository instance for data access.
        data_store (GenericDataStore, optional): An optional data store for KB LLM Prompt retrieval.
    """

    SCHEMA = schema_dict["kb_llm_prompt"]
    ...
    def __init__(
        ...
        """Initializes the KbLLMPromptService.
