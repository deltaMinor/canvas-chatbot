...
default_code_message_mapping = {
    404: "App TNC not found.",
    409: "App TNC conflict.",
}
...
class AppTNCService(
    ...
    """Service for managing app TNC (Terms and Conditions) entities.

    This service provides methods to interact with app TNC entities,
    ...
    Attributes:
        SCHEMA (str): The schema version for app TNC entities.
        repository (Repository | RemoteRepository): The repository instance for data access.
        data_store (GenericDataStore, optional): An optional data store for app TNC retrieval.
    """

    SCHEMA = schema_dict["app_tnc"]
    ...
    @raise_exception(
        "Failed to get muliple document from domain.",
        exception_logger=logger,
    )
    def get_many(
        self,
