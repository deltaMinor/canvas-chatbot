...
default_code_message_mapping = {
    404: "Project CQ not found.",
    409: "Project CQ conflict.",
}

logger = logging.getLogger(__name__)


class ProjectCQService(
    DomainRepositoryService,
    DomainRequestDataPrefilterService,
    DomainAuditLogService,
    DomainProjectAuthorizationService,
):
    """Service for managing project CQ entities.

    This service provides methods to interact with project CQ entities,
    ...
    def __init__(
        ...
        """Initializes the ProjectCQService.
