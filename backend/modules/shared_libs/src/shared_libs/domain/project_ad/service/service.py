...
default_code_message_mapping = {
    404: "Project diagram not found.",
    409: "Project diagram conflict.",
}

logger = logging.getLogger(__name__)


class ProjectADService(
    DomainRepositoryService,
    DomainRequestDataPrefilterService,
    DomainAuditLogService,
    DomainProjectAuthorizationService,
):
    """Service for managing project AD (architecture diagram) entities.

    This service provides methods to interact with project AD entities,
    ...
    def __init__(
        ...
        """Initializes the ProjectADService.
