...
default_code_message_mapping = {
    404: "User policy document not found.",
    409: "User policy document conflict.",
}

logger = logging.getLogger(__name__)


class UserPolicyDocService(
    DomainRepositoryService,
    DomainRequestDataPrefilterService,
    DomainAuditLogService,
    DomainAuthorizationService,
):
    """Service for managing user policy documents.

    This service provides methods to interact with user policy documents,
    ...
    def __init__(
        ...
        """Initializes the UserPolicyDocService.
