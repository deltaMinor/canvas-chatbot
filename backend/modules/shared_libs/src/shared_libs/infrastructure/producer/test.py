...
default_code_message_mapping = {
    404: "KB generation rule not found.",
    409: "KB generation rule conflict.",
}

logger = logging.getLogger(__name__)


class KbGenerationRuleService(
    DomainRepositoryService,
    DomainRequestDataPrefilterService,
    DomainAuditLogService,
    DomainAuthorizationService,
):
    """Service for managing KB Generation Rule entities.

    This service provides methods to interact with KB Generation Rule entities,
    ...
    Attributes:
        SCHEMA (dict): The schema definition for KB Generation Rule entities.
        repository (Repository | RemoteRepository): The repository instance for data access.
        data_store (GenericDataStore, optional): An optional data store for KB Generation Rule retrieval.
    """

    SCHEMA = schema_dict["kb_generation_rule"]
    ...
    def __init__(
        ...
        """Initializes the KbGenerationRuleService.
