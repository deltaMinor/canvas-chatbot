...
class AttackFlowBundleFactory:
    CREATED_AT = datetime(2022, 8, 25, 19, 26, 31)
    MODIFIED_AT = datetime(2022, 8, 25, 19, 26, 31)

    @classmethod
    def build_flow_bundle(cls):
        asset_obj = stix2.Infrastructure(
            id="infrastructure--79d21912-36b7-4af9-8958-38949dd0d6de",
            created=cls.CREATED_AT,
            modified=cls.MODIFIED_AT,
            name="My Infra",
        )
        asset = StixAttackAsset(
