...
class ValidityInfo:
    def __init__(self, priority, description, title):
...
class EdgeValidityInfo(ValidityInfo):
    def __init__(self, edgeId, priority, description, title):
        super().__init__(priority, description, title)
        self.edgeId = edgeId
...
class HierarchyValidityInfo(ValidityInfo):
    def __init__(self, nodeId, priority, description, title):
        super().__init__(priority, description, title)
        self.nodeId = nodeId
